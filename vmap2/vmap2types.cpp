...
void
VMap2types::write_typ(const std::string & fname, const int FID) const {
  ...
  for (const auto tt: *this){
    ...
    if (tt.second.name!="")
      ff << "string1=0x00," << tt.second.name << "\n";
    if (tt.second.name!="")
      ff << "string2=0x04," << tt.second.name << "\n";
    if (tt.second.name_ru!="")
      ff << "string3=0x19," << tt.second.name_ru << "\n";
    if (tt.second.name_fi!="")
      ff << "string4=0x06," << tt.second.name_fi << "\n";
    if (cl==VMAP2_LINE){
