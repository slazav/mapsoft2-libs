...
main(){
  try {
    ...
    "# \\opt3=\n"
    "1200 2\n"
    "4 0 0 50 -1 0 12.000 0.0000 4 210 150 -1575 6840 text\\\\120PŸ\\001\n"
    "2 1 0 1 0 7 50 -1 -1 0.000 0 0 -1 1 1 4\n"
    "\t0 0 1.00 60.00 120.00\n"
    "\t0 0 1.00 60.00 120.00\n"
    "\t315 1440 810 945 1800 1215 3330 675\n"
    ...
    assert_eq(w.size(), 2);
    assert_eq(w.begin()->text, "text\\120P—ã");
    }
    ...
    "\t0 0 1.00 60.00 120.00\n"
    "\t315 1440 810 945 1800 1215 3330 675\n"
    "4 0 0 50 -1 0 12.000 0.0000 4 210 150 -1575 6840 ‘≈À”‘\\001\n",
    "<in>", 1);
    assert_eq(w.size(), 2);
    assert_eq(w.comment.size(),2);
    assert_eq(w.comment[0],"–∫–æ–º–º–µ–Ω—Ç1");
    assert_eq(w.comment[1],"\\–∫–ª—é—á1=–∑–Ω–∞—á–µ–Ω–∏–µ1");
    assert_eq(w.begin()->comment.size(),2);
    assert_eq(w.begin()->comment[0],"–∫–æ–º–º–µ–Ω—Ç2");
    assert_eq(w.begin()->comment[1],"\\–∫–ª—é—á2=–∑–Ω–∞—á–µ–Ω–∏–µ2");
    assert(w.rbegin()->is_text());
    assert_eq(w.rbegin()->text, "—Ç–µ–∫—Å—Ç");
    }
