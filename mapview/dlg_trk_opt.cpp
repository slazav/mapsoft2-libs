...
DlgTrkOpt::DlgTrkOpt(){
  ...
  m_normal->signal_toggled().connect(
      sigc::bind(sigc::mem_fun(this, &DlgTrkOpt::on_ch), 0));
  ...
  dots->signal_toggled().connect(
      sigc::bind(sigc::mem_fun(this, &DlgTrkOpt::on_ch), 1));
  arrows->signal_toggled().connect(
      sigc::bind(sigc::mem_fun(this, &DlgTrkOpt::on_ch), 1));

  rv->signal_changed().connect(
      sigc::bind(sigc::mem_fun(this, &DlgTrkOpt::on_ch), 2));
  rh->signal_changed().connect(
      sigc::bind(sigc::mem_fun(this, &DlgTrkOpt::on_ch), 3));
